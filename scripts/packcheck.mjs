...
for (const required of ['src/work-budget.js', 'docs/HUMAN-REVISION.md', 'docs/HUMAN-REVISION.en.md', 'docs/CANDIDATE-REVIEW.md', 'docs/CANDIDATE-REVIEW.en.md', 'docs/RECOVERY-DISPATCH.md', 'docs/RECOVERY-DISPATCH.en.md', 'src/runtime-recovery.js', 'src/artifact-paths.js', 'docs/RUNTIME-RECOVERY.md', 'docs/RUNTIME-RECOVERY.en.md', 'src/workflow-ux.js', 'src/controller-ux.js', 'src/media-diagnostics.js', 'docs/WORKFLOW-UX.md', 'src/run-isolation.js', 'src/host-isolation.js', 'docs/RUN-ISOLATION.md', 'src/project-library.js', 'src/intake-policy.js', 'src/domain-sops.js', 'docs/PROJECT-SOPS.md', 'src/sops.js', 'src/routing.js', 'src/automation.js', 'src/tool.js', 'src/host.js', 'src/receipts.js', 'src/context.js', 'src/quality.js', 'src/media_worker.py', 'src/media-checks.js', 'src/host-media.js', 'src/run-control.js', 'src/video-sop.js', 'src/report-export.js', 'docs/MEDIA-REVISION.md', 'docs/MEDIA-REVISION.en.md', 'README.md', 'README.en.md', 'docs/SOP-CATALOG.md']) assert.ok(paths.has(required), `Missing ${required}`)
